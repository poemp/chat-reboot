...
public class AliceBotTest extends TestCase {
  ...
  */
    ...
    public void testPredicates() {
        assertEquals("Nice to meet you, H�lio. :-)", bot.respond("My name is H�lio."));
        assertEquals("H�lio", (String) bot.getContext().property("predicate.name"));
        assertEquals("Thank you, H�lio.", bot.respond("Nice to meet you, too."));
